...
static Menu_MenuItem Pwrsts_StatsMenuItems[] = {{Pwr_DeviceStr, NULL, NULL}, {Pwr_StateStr, NULL, NULL}, {Pwrsts_WorktimeStr, NULL, NULL}, {Pwrsts_PreviousWorktimeStr, NULL, NULL}, {"Up:update|Sel:return", NULL, NULL}};

Menu_Menu Pwrsts_StatsMenu = {"Power stats", Pwrsts_StatsMenuItems, MENU__COUNT_OF(Pwrsts_StatsMenuItems), 0, Pwrsts_updateProc, NULL, NULL, NULL};
...
static Menu_MenuItem Pwrmng_PowerMenuItems[] = {{Pwr_DeviceStr, NULL, NULL}, {Pwr_StateStr, NULL, NULL}, {"Turn on", NULL, Pwrmng_turnOnProc}, {"Turn off", NULL, Pwrmng_turnOffProc}, {"Return", NULL, NULL}};

Menu_Menu Pwrmng_PowerMenu = {"Power stats", Pwrmng_PowerMenuItems, MENU__COUNT_OF(Pwrmng_PowerMenuItems), 0, Pwrmng_upProc, Pwrmng_selectProc, Pwrmng_downProc, NULL};
